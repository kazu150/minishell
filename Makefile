...
#    Updated: 2025/11/16 16:56:42 by kaisogai         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIBFT	= libft/libft.a
SRCS	= main.c parse.c command.c tokenize.c tokenize_utils.c tokenize_utils2.c expand.c expand_utils.c builtin_fn/ft_echo.c heredoc.c builtin_fn/ft_pwd.c builtin_fn/ft_cd.c env.c builtin_fn/ft_env.c builtin_fn/ft_export.c builtin_fn/ft_exit.c builtin_fn/ft_unset.c builtin_fn/index.c utils/free.c utils/path.c utils/signal.c utils/error.c utils/string.c parse_utils.c parse_utils2.c parse_utils3.c builtin_fn/export_utils.c
OBJS	= $(SRCS:.c=.o)
